...
- Return: [NodeRenderReturnType](https://flowgram-ai.org/auto-docs/fixed-layout-editor/interfaces/NodeRenderReturnType.html)
...
- Return: [NodeRenderReturnType](https://flowgram-ai.org/auto-docs/free-layout-core/interfaces/NodeRenderReturnType.html)
