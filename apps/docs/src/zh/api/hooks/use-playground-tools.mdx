...
- Return: [PlaygroundTools](https://flowgram-ai.org/auto-docs/fixed-layout-editor/interfaces/PlaygroundTools.html)
```tsx pure
...
- Return: [PlaygroundTools](https://flowgram-ai.org/auto-docs/free-layout-editor/interfaces/PlaygroundTools.html)
