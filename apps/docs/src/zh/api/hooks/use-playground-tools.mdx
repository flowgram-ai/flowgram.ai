...
- Return: [PlaygroundTools](https://flowgram-ai.github.io/flowgram.ai/auto-docs/fixed-layout-editor/interfaces/PlaygroundTools.html)
```tsx pure
...
- Return: [PlaygroundTools](https://flowgram-ai.github.io/flowgram.ai/auto-docs/free-layout-editor/interfaces/PlaygroundTools.html)
